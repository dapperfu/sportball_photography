...
from .adapters import FaceDetectionAdapter, ObjectDetectionAdapter, QualityAssessmentAdapter
...
class DetectionIntegration:
    ...
    def detect_with_tool(self, tool_name: str, image_paths: Union[Path, List[Path]], 
                        ...
                        **kwargs) -> Union[DetectionResult, Dict[str, DetectionResult]]:
        """
        ...
        if not tool:
            ...
            return error_result if single_image else {str(path): error_result for path in image_paths}
    ...
    def register_custom_tool(self, tool_name: str, tool_class, 
